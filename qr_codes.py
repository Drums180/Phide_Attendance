...
if os.path.exists(csv_path):
    ...
    df_fraternos.rename(columns={"Matricula": "id", "Nombre Completo": "nombre"}, inplace=True)

    # Verificar que las columnas necesarias existen
    if {"id", "nombre"}.issubset(df_fraternos.columns):
        ...
        print("⚠ ERROR: 'fraternos.csv' no contiene las columnas necesarias ('id', 'nombre').")
else:
